...
public class MapStyleCustom implements MapStyle {
	...
	public BufferedImage getMapTexture() {
		if(round) {
			return getImage("/assets/minimap/minimap/roundmap.png");
		}else {
			return getImage("/assets/minimap/minimap/squaremap.png");
		}
	}
	...
	public BufferedImage getMaskTexture() {
		if(round) {
			return getImage("/assets/minimap/minimap/roundmap_mask.png");
		}else {
			return getImage("/assets/minimap/minimap/squaremap_mask.png");
		}
	}
